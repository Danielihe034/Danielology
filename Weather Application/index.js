const apiKey = "07ab369f051b7857da25a7264962896b";
...
function fetchWeatherData(location) {
  // Construction of API Url with location and APIKey
  ...
  fetch(apiUrl)
    ...
    .then((data) => {
      ...
      // Updating the location and weather description in the "left-info" section
      ...
      for (const dayData of nextDaysData) {
        ...
        // If statment to stop days from repeating
        if (
        ...
        // If statement to stop after 4 days
        if (count === 4) break;
      }
    })
    .catch((error) => {
...
document.addEventListener("DOMContentLoaded", () => {
  const defaultLocation = "San Antonio";
